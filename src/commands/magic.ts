...
Modified: 2022-01-31T07:08:54.618Z
*/
import { alias, arg, Collection, Command, description, Float, Int, List, opt } from '../core'
@alias('n')
...
class NaviCMD extends Command {
	async action(@arg name: string) {
		console.log(name)
	}
}